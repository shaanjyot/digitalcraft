                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold mb-8 leading-tight">
                            ...
                            <span className="text-[#5b6f73]">GOLD</span>
                        </h1>
                        <p className="text-xl text-[#5b6f73]/70 leading-relaxed max-w-2xl mx-auto">
                            Complete web solution for businesses ready to go online
                        </p>
                    </div>

                    <div className="max-w-md mx-auto relative bg-white rounded-2xl border border-[#3eb4d6]/30 shadow-xl shadow-[#3eb4d6]/5 p-8 transition-all duration-300">
