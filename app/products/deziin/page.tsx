    ...
    const steps = [
        {
            num: "01",
            title: "Discover",
            desc: "45-min session to align on goals, ideas & design direction.",
            icon: HiChatAlt2,
            color: "text-[#3eb4d6]",
            bg: "bg-[#3eb4d6]/10",
        },
        {
            num: "02",
            title: "Design",
            desc: "We craft visuals based on your brand voice & strategy.",
            icon: HiLightBulb,
            color: "text-[#99f200]",
            bg: "bg-[#99f200]/10",
        },
        {
            num: "03",
            title: "Review",
            desc: "You share feedback; we refine with a clear, structured approach.",
        ...
        },
        {
            num: "04",
            title: "Launch",
            desc: "Final files delivered, ready for print & digital use.",
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl mx-auto text-center mb-20">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight">
                            DEZIIN: Visual Design for{" "}
                            <span className="text-[#3eb4d6]">Impact</span>
                        </h1>
                        <p className="text-xl text-[#5b6f73]/80 leading-relaxed max-w-3xl mx-auto">
                            From brand visuals to brochures, flyers & digital content—versatile designs that drive marketing, engagement & storytelling.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24 relative">
                        ...
                        <div className="hidden lg:block absolute top-[2.5rem] left-0 right-0 h-0.5 bg-gradient-to-r from-[#3eb4d6]/20 via-[#99f200]/20 to-[#3eb4d6]/20 z-0"></div>

                        {steps.map((step, idx) => (
                            <div key={idx} className="relative z-10 group">
                                <div className={`w - 20 h - 20 mx - auto rounded - 2xl ${step.bg} flex items - center justify - center mb - 6 transform group - hover: scale - 110 transition - transform duration - 300 shadow - sm`}>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
                        ...
                        <div className="space-y-8 animate-fade-in-up">
                            <div>
                                <h2 className="text-4xl font-display font-bold text-[#3eb4d6] mb-6">DEZIIN</h2>
                                <div className="space-y-6 text-lg text-[#5b6f73]/80 leading-relaxed">
                                    <p className="font-medium text-[#5b6f73]">
                                        DEZIIN is all about branding and logo design.
                                    </p>
                                    <p>
                                        We help you create an identity for your business that resonates with your values and connects with your audience.
                                    </p>
                                    <p>
                                        We offer customized logos designed and crafted by the best team of artists and graphic designers, ensuring your brand stands out in the market.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="relative bg-white rounded-[2rem] p-8 sm:p-10 shadow-xl border border-white/50 backdrop-blur-sm">
                                ...
                                <div className="flex justify-between items-start mb-10 border-b border-gray-100 pb-8">
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-display font-bold text-[#5b6f73]">Identify</h3>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-5xl font-bold text-[#3eb4d6] tracking-tight">$299</div>
                                ...
                                <p className="text-center text-xs text-[#5b6f73]/40 mt-4">No hidden fees. 100% satisfaction guaranteed.</p>
                            </div>
                        </div>
